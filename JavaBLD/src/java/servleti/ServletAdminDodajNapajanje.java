 ...
 * @author Bojan
 */
public class ServletAdminDodajNapajanje extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        for(int a = 0;a<podaci.size();a++)
        {
            ...
            {
                request.setAttribute("psuPokazi", "da");
                request.setAttribute("praznaPoljaPsu", "Morate popuniti sva polja!");
                ...
                try
                {
                    ...
                    {
                        request.setAttribute("psuPokazi", "da");
                        request.setAttribute("praznaSlikaPsu", "Morate izabrati sliku!");
                        request.getRequestDispatcher("AdminDodajDeo.jsp").forward(request, response);
                        return;
                    }
                    else
                    {
                        SQLQuery q=s.createSQLQuery("insert into psu(naziv,efikasnost,jacina,modularnost,imgPath)"
                    ...
                    s.close();
                    response.sendRedirect("ServletAdminPrikazDelova?deo=psu");
                    return;
                }
