 ...
 * @author Bojan
 */
public class ServletAdminDodajRAM extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        for(int a = 0;a<podaci.size();a++)
        {
            ...
            {
                request.setAttribute("ramPokazi", "da");
                request.setAttribute("praznaPoljaRam", "Morate popuniti sva polja!");
                ...
                try
                {
                    ...
                    {
                        request.setAttribute("ramPokazi", "da");
                        request.setAttribute("praznaSlikaRam", "Morate izabrati sliku!");
                        request.getRequestDispatcher("AdminDodajDeo.jsp").forward(request, response);
                        return;
                    }
                    else
                    ...
                    s.close();
                    response.sendRedirect("ServletAdminPrikazDelova?deo=ram");
                    return;
                }
