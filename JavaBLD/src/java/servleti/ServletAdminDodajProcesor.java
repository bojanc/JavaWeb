 ...
 * @author Bojan
 */
public class ServletAdminDodajProcesor extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        for(int a = 0;a<podaci.size();a++)
        {
            ...
            {
                request.setAttribute("cpuPokazi", "da");
                request.setAttribute("praznaPoljaCpu", "Morate popuniti sva polja!");
                ...
                try
                {
                    ...
                    {
                        request.setAttribute("cpuPokazi", "da");
                        request.setAttribute("praznaSlikaCpu", "Morate izabrati sliku!");
                        request.getRequestDispatcher("AdminDodajDeo.jsp").forward(request, response);
                        return;
                    }
                    else
