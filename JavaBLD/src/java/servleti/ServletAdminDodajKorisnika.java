 ...
 * @author Bojan
 */
public class ServletAdminDodajKorisnika extends HttpServlet {
                ...
                try
                {
                    ...
                    if(imgpa.length()==21)
                    {
                        SQLQuery q=s.createSQLQuery("insert into korisnici(imgPath,ime,prezime,username,password,uloga)"
                            + "VALUES('images/img_avatar.png', '"+podaci.get(0)+"', '"+podaci.get(1)+"', '"+podaci.get(2)+"', '"+sha1+"', '"+podaci.get(4)+"')");
                        q.executeUpdate();
                        tr.commit();
                    }
                    else
                    {
                        SQLQuery q=s.createSQLQuery("insert into korisnici(imgPath,ime,prezime,username,password,uloga)"
                            + "VALUES('"+imgpa+"', '"+podaci.get(0)+"', '"+podaci.get(1)+"', '"+podaci.get(2)+"', '"+sha1+"', '"+podaci.get(4)+"')");
                        q.executeUpdate();
                        tr.commit();
                    }
