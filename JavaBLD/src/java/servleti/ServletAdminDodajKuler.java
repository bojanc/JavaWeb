 ...
 * @author Bojan
 */
public class ServletAdminDodajKuler extends HttpServlet {
        ...
        for(int a = 0;a<podaci.size();a++)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        SQLQuery q=s.createSQLQuery("insert into kuleri(naziv,rpm,buka,radijatorDim,imgPath)"
                    ...
                    s.close();
                    response.sendRedirect("ServletAdminPrikazDelova?deo=kuleri");
                    return;
                }
