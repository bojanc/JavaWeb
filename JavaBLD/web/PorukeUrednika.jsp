									...
									<li style="color: #d4d4d6;">
										...
										<a href="#">
                                                                ...
                                                                <%
                                                                    ...
                                                                    ArrayList<Porukeurednika> porukeU = (ArrayList<Porukeurednika>)request.getAttribute("porukeU");
                                                                %>
								...
								<header>
										...
										<h2>
                                                                        ...
                                                                        <%
                                                                                    if(porukeU.size()>0)
                                                                                    {       
                                                                                           for(Porukeurednika pomU:porukeU)
                                                                                           {
                                                                                               if(pomU.getPorukekorisnika().getPorukaKorisnikaId() == pom.getPorukaKorisnikaId())
                                                                                               {
                                                                        %>
                                                                        <tr style="background-color:transparent;border-top: none;">
                                                                            <td style="padding-left:200px;">
                                                                                <img src="<%= pomU.getKorisnici().getImgPath() %>" height="30" width="30" style="border-radius: 50%;vertical-align: middle;display: inline-block;margin-right: 10px;"/>
                                                                                     <h4 style="width: 40%;margin:0;display: inline-block;"><%= pomU.getKorisnici().getIme() %> <%= pomU.getKorisnici().getPrezime() %>&nbsp;&nbsp;&nbsp;&nbsp;  <%= pomU.getVreme() %></h4><br><br>
                                                                                     
                                                                                     <h4>Odgovor urednika</h4>
                                                                                    <textarea name="poruka" class="poruke"  cols="2" rows="5" style="resize: none;width: 100%;" readonly><%= pomU.getTekst() %></textarea><br><br>
                                                                        ...
                                                                        %>
                                                                        <h2>
                                                                            Trenutno nema poruka korisnika!
                                                                        </h2>
                                                                        <%
                                                                            }
                                                                        %>
