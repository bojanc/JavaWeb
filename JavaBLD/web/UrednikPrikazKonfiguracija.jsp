							...
							<section>
                                ...
                                <div id="myModalP" class="modal">
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <p style="margin-bottom:5px;"><b>Konfiguracija uspešno odobrena!</b></p>
                                  </div>
                                ...
                                <div id="myModalO" class="modal">
                                  ...
                                  <!-- Modal content -->
                                  <div class="modal-content">
                                    <span class="close" id="closeO">&times;</span>
                                    <p style="margin-bottom:5px;"><b>Konfiguracija uspešno odbijena!</b></p>
                                  </div>
                                ...
                                <script>
                                    ...
                                    var spanO = document.getElementById("closeO");
                                    <%
                                    if(request.getAttribute("odobreno")!=null)
                                    {
                                %>
                                    $(document).ready(function(){
                                ...
                                window.onclick = function(event) {
                                  if (event.target == modalP || event.target == modalO) {
                                    modalP.style.display = "none";
                                    modalO.style.display = "none";
                                  }
                                }
                                ...
                                <style>
                                            ...
                                            .button.odobri:hover {
                                                box-shadow: inset 0 0 0 1px rgba(34,204,39);
                                                color: rgba(34,204,39) !important;
                                            }
                                </style>
									...
									<ul class="stats" style="font-size:180% !important;">
                                                        ...
                                                        <article class="post" style="max-width: 50%; margin: auto;">
                                                            <h2 style="color: black;text-align: center;">
                                                                Trenutno nema konfiguracija za odobravanje!
                                                            </h2>
							</article>
                                                            <%
                                                                }
