								...
								<header>
									<div class="title">
										<h2>
                                                                                    ...
                                                                                    <img src="<%= konfig.getKorisnici().getImgPath() %>" height="60" width="60" style="border-radius: 50%;vertical-align: middle;box-shadow: 2px 2px 6px 0px rgba(0,0,0,0.75);"/>
                                                                                </h2>
										<p><%= konfig.getOpis() %></p>
									</div>
										...
										<img src="<%= konfig.getImgPath() %>" style="width:100%;height: 100%;box-shadow: 3px 3px 6px 1px rgba(0,0,0,0.75);"/>
                                                                        ...
                                                                        <table><input type="hidden" name="konfigID" value="<%= komentar.get(0).getKonfiguracije().getKonfiguracijaId() %>">
                                                                            ...
                                                                            <tr style="background-color:transparent;border-top: none;">
                                                                                ...
                                                                                <h4 style="width: 15%;margin:0;display: inline-block;"> <%= pom.getKorisnici().getIme() %> <%= pom.getKorisnici().getPrezime()%> </h4><%if(korisnik!=null){ if(korisnik.getUloga().equals("Admin") || korisnik.getUloga().equals("Urednik") || korisnik.getKorisnikId() == pom.getKorisnici().getKorisnikId()){ %><a href="ServletKomentarObrisi?komid=<%= pom.getKomentarId() %>&konfigid=<%= pom.getKonfiguracije().getKonfiguracijaId() %>" class="button" id="buttonobrisi" style="float:right;display: inline-block;margin-left: 50px;box-shadow: inset 0px 0px 0px 1px rgba(255,0,0,1);">Obriši</a><%}}%>
                                                                            ...
                                                                            <tr style="background-color:transparent;border-top: none;">
                                                                                ...
                                                                                <img src="<%= pom.getKorisnici().getImgPath() %>" height="30" width="30" style="border-radius: 50%;vertical-align: middle;display: inline-block;margin-right: 10px;"/>
                                                                                <h4 style="width: 40%;margin:0;display: inline-block;"> <%= pom.getKorisnici().getIme() %> <%= pom.getKorisnici().getPrezime()%> : <img src="<%= pomp.getKorisnici().getImgPath() %>" height="30" width="30" style="border-radius: 50%;vertical-align: middle;display: inline-block;margin-right: 10px;"/> <%= pomp.getKorisnici().getIme() %> <%= pomp.getKorisnici().getPrezime()%></h4> <%if(korisnik!=null){ if(korisnik.getUloga().equals("Admin") || korisnik.getUloga().equals("Urednik") || korisnik.getKorisnikId() == pomp.getKorisnici().getKorisnikId()){ %><a href="ServletKomentarObrisi?id=<%= pomp.getPodkomentarId() %>&konfigid=<%= pom.getKonfiguracije().getKonfiguracijaId() %>" class="button" id="buttonobrisi" style="float:right;display: inline-block;margin-left: 50px;box-shadow: inset 0px 0px 0px 1px rgba(255,0,0,1);">Obriši</a><%}}%>
