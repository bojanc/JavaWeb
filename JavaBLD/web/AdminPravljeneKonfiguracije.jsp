			...
			<div id="wrapper">
				...
				<!-- Main -->
					...
					<div id="main">
                                            ...
                                            <!--</form>-->
                                                <div style="float:right; width: 800px;padding-bottom: 250px;margin-top: 30px;margin-right: -150px;">
                                            ...
                                            <div style='float:right;width:50%;padding-bottom: 50px;'>
                                                ...
                                                <img id="pic" src="#" alt="" style="box-shadow: 4px 4px 6px 1px rgba(0,0,0,0.75);"/>
                                            </div>
