			...
			<div id="wrapper">
								...
								<ul class="links">
									...
									<li style="color: #d4d4d6;">
										...
										<a href="ServletAdminPrikazDelovaKonfig">
                                                                        ...
                                                                        %>
                                                                <%
                                                                    ArrayList<Porukekorisnika> poruke = (ArrayList<Porukekorisnika>)request.getAttribute("poruke");
                                                                %>
							...
							<section>
                                ...
                                <div id="myModalP" class="modal">
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <p style="margin-bottom:5px;"><b>Poruka uspešno poslata!</b></p>
                                  </div>
                                ...
                                <script>
                                    ...
                                    <%
                                        if(request.getAttribute("poslato")!=null)
                                        {
                                    %>
				...
				<!-- Main -->
					<div id="main">
						...
						<!-- Post -->
                                                <form method="post" action="ServletPrikazPorukaKorisnika">
							<article class="post">
								<header>
                                                                    <div class="title">
										<h2>
                                                                        ...
                                                                        <%
                                                                            if(poruke.size()>0)
                                                                            {
                                                                                for(Porukekorisnika pom:poruke)
                                                                                {
                                                                        %>
                                                                        <table>
                                                                            <tr style="background-color:transparent;border-top: none;">
                                                                                <td>
                                                                                    ...
                                                                                    <h4 style="width: 40%;margin:0;display: inline-block;"><%= pom.getKorisnici().getIme() %> <%= pom.getKorisnici().getPrezime() %>&nbsp;&nbsp;&nbsp;&nbsp;  <%= pom.getVreme() %></h4><br><br>
                                                                                    
                                                                                    
                                                                                    <div id="poruka<%= pom.getPorukaKorisnikaId() %>" class="odgovorpodpodkom" style="display: none;">
                                                                                        <h4>Poruka korisnika</h4>
                                                                                        <textarea name="poruka" class="poruke" id="tekst<%= pom.getPorukaKorisnikaId() %>"  cols="2" rows="5" style="resize: none;width: 100%;" readonly><%= pom.getTekst() %></textarea><br><br>
                                                                                        <h4>Odgovor</h4>
                                                                                        
                                                                                        <textarea name="odgovorPoruka" class="odgovorP" id="odgovorTekst<%= pom.getPorukaKorisnikaId() %>"  cols="2" rows="5" style="resize: none;width: 100%;"></textarea><br><br>
                                                                                        <input type="hidden" class="odgovorVrednost" name="odgovorID" id="odgovorID<%= pom.getPorukaKorisnikaId() %>" value="<%= pom.getPorukaKorisnikaId() %>">
                                                                                        
                                                                                        <span class="close" id="closeP" onclick="zatvori('reply<%= pom.getPorukaKorisnikaId() %>','poruka<%= pom.getPorukaKorisnikaId() %>')">&times;</span>
                                                                                        <input type="submit" value="Odgovori" style="float:right;margin-right: 50px;">
                                                                                    </div>
                                                                                    
                                                                                    
                                                                                    <a href="#" id="reply<%= pom.getPorukaKorisnikaId() %>" class="ikona" style="float:right;border-bottom: none" onclick="otvoriOdgovor('odgovorTekst<%= pom.getPorukaKorisnikaId() %>','poruka<%= pom.getPorukaKorisnikaId() %>','odgovorID<%= pom.getPorukaKorisnikaId() %>')"><i class="fa fa-reply" aria-hidden="true"></i></a>
                                                                        ...
                                                                        <script>
                                                                            ...
                                                                            function otvoriOdgovor(obj,obj1,obj2) {
                                                                              var x = document.getElementsByClassName("ikona");
                                                                              var y = document.getElementsByClassName("poruke");
                                                                              var z = document.getElementsByClassName("odgovorP");
                                                                              var b = document.getElementsByClassName("odgovorVrednost");
                                                                              ...
                                                                              document.getElementById(obj).setAttribute("name", "odgovorPoruka"); 
                                                                              document.getElementById(obj2).setAttribute("name", "odgovorID"); 
                                                                              document.getElementById(obj1).style.display = "block";
                                                                              
                                                                            }
                                                                            
                                                                            function zatvori(obj,obj1) {
                                                                              var x = document.getElementsByClassName("ikona");
