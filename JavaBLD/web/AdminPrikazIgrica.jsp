                                                                        ...
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <%
                                                                                ...
                                                                                {%>
                                                                                    <div class="dropdown">
                                                                                        <div id="myDropdown<%= a %>" class="dropdown-content"  style='margin-left:-47px;white-space: nowrap;overflow: hidden;'>
                                                                                          <a href="DodavanjeFPSa?id=<%= pom.getIgricaId() %>" style="border:none;">Izračunaj FPS za konfiguraciju</a>
                                                                                          <a href="FPSzaKonfig?id=<%= pom.getIgricaId() %>" style="border:none;">Konfiguracije</a>
                                                                                        </div>
                                                                                    </div>
                                                                                <%}}else{%>
                                                                        <div class="dropdown">
