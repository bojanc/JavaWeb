						...
						<!-- Actions -->
							<section>
                                ...
                                <%
                                    ...
                                    if(request.getAttribute("igrica")!=null)
                                    {
                                        igrica = (Igrice)request.getAttribute("igrica");
                                    }
...
<%}
                                                            %>
                                                          <input type="text" name="naziv" id="imekor" placeholder="Naziv" value='<%= igrica.getIgricaNaziv() %>' style="width: 40%; margin:0 !important;" onchange="return imekorcheck()">
                                                        ...
                                                        <select name="cpu" style="width: 40%;" id="sel">
                                                            <optgroup>
                                                                ...
                                                                <option value="<%= pom.getProcesorId() %>"  <%if(igrica.getProcesori().getProcesorId() == pom.getProcesorId()){ %> selected <%}%>><%= pom.getNaziv() %></option>
                                                                <%
                                                        ...
                                                        <select name="gpu" style="width: 40%;" id="sel">
                                                            <optgroup>
                                                                ...
                                                                <option value="<%= pom.getGpuId()%>" <%if(igrica.getGpu().getGpuId() == pom.getGpuId()){ %> selected <%}%>><%= pom.getNaziv() %></option>
                                                                <%
                                                        ...
                                                        <select name="ram" style="width: 40%;" id="sel">
                                                            <optgroup>
                                                                ...
                                                                <option value="<%= pom.getRamId()%>" <%if(igrica.getRam().getRamId() == pom.getRamId()){ %> selected <%}%>><%= pom.getNaziv() %></option>
                                                                <%
                                                            ...
                                                            <input type='hidden' name='igricaID' value='<%= igrica.getIgricaId() %>'>
